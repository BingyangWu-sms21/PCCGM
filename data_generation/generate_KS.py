...
if __name__ == "__main__":
    ...
    parser.add_argument('-d', '--datasize', type=int, default=5,
    ...
    parser.add_argument('-f', '--filename', type=str, default='KS_dataset_test.npz',
    ...
    num_cores = 64 #multiprocessing.cpu_count() - 4
    ...
    print(np.shape(nu_list))
    print(np.shape(np.stack([nu_list.flatten()], axis = 1)))
